              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-2 md:gap-3">
                ...
                <button
                  onClick={() => {
                    ...
                    if (!trailerKey) {
                      fetchTrailer(film.title);
                    } else {
                      setShowTrailer(true);
                    }
                  }}
                  className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 shadow-lg shadow-red-500/30 text-white px-4 md:px-6 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 font-semibold text-sm md:text-base w-full sm:w-auto text-center flex items-center justify-center gap-2"
                >
